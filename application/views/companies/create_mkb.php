...
<html>
<head>
	<?php echo $this->load->view('head', array('title' => ('add mkb'))); ?>
</head>
...
<div class="container">
	<div class="row">
		...
		<div class="span10">
			...
			<div class="well">
				<?php echo("Pridat MKB - manazer kyberbezpenosti"); ?>
			</div>
<?php //var_dump($company);?>
			<?php echo form_open('companies/create_mkb/'. $company['id'], 'class="form-horizontal"'); ?>
			<?php echo validation_errors(); ?>

			<div class="control-group">
				<label class="control-label" for="name"><?php echo('Název společnosti'); ?></label>
				<div class="controls">
					<?php echo form_input(array('name' => 'company_name'),$company['name'], 'disabled'); ?>
				</div>
