<div style="border-right: 1px solid #ebebeb">
	<div style="width: 100%; height: 100px; opacity: 0.6;">
		<div style="position: relative; left: 25%; top: 5%;" ><h1 style="text-shadow: 3px 2px #7684ff; color: white;">KTG</h1><p style="position: relative; left: -1%"><sup>Kyber Tech Group</sup></p></div>
	</div>
<br>
