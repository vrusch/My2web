<div style="border-right: 1px solid #ebebeb">
	...
	<ul class="nav nav-list" style="padding-right: 20px">
		<li class="nav-header">Spusteny kviz</li>
			<li style="color: #fff; text-shadow: 0 -1px 0 rgba(0,0,0,0.2); background-color: #08c; padding-top: 3px; padding-right: 15px; padding-bottom: 3px; padding-left: 15px;">  <?php echo $quizz_info['name'] ;?></li>
	</ul>
</div>
