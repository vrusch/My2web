...
<html>
<head>
	<?php echo $this->load->view('head', array('title' => ('slogan'))); ?>
</head>
<body>
...
<div class="container">
	<div class="row">
		...
		<div class="span2">
			<?php echo $this->load->view('account/admin_panel', array('current' => 'manage_slogan')); ?>
		</div>
		...
		<div class="span10">
			...
			<table style="width: 100%">
				<tr>
					<td style="width: 85%"><h2><?php echo ('slogan'); ?></h2></td>
